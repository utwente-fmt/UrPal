...
public abstract class AbstractProperty {
    public static final AbstractProperty[] properties = {/* new BreadthFirstBaseLine(), new DepthFirstBaseLine(),*/
            ...
            new SystemLocationReachabilityMeta(),/* new SystemLocationReachabilityMetaSmart(),*/
            new TemplateLocationReachabilityMeta(), /*new TemplateLocationReachabilityMetaSmart(),*/
            new SystemEdgeReachabilityMeta(), /*new SystemEdgeReachabilityMetaSmart(),*/
    ...
    static void engineQuery(UppaalSystem sys, SymbolicState init, String query, String options,
    ...
    static void engineQuery(UppaalSystem sys, String query, String options,
                            BiConsumer<QueryResult, ArrayList<SymbolicTransition>> cb) throws IOException, EngineException {
